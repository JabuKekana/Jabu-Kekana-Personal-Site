...
export const services = [
  {
    ...
    modalTitle: "Business Web Development",
    points: [
      "Build modern business websites and web applications using React JS, JavaScript, responsive UI and practical hosting workflows.",
      "Translate business ideas into usable digital products that support client acquisition and day-to-day operations.",
      "Improve user experience, interface flow, performance, content structure and mobile responsiveness.",
      "Advise clients on hosting, deployment and practical digital presence decisions.",
    ],
  },
  {
    icon: "uil uil-robot",
    title: "AI & Automation",
    modalTitle: "AI & Automation",
    points: [
      "Research and prototype AI support tools using LangChain.js, OpenAI APIs, TensorFlow.js and custom business data.",
      "Design chatbot workflows that answer frequent questions and escalate complex cases to human agents.",
      "Help businesses identify repetitive tasks that can be reduced through practical automation.",
      "Connect AI ideas to real business outcomes instead of only building experimental demos.",
    ],
  },
  {
    icon: "uil uil-cloud",
    title: "Cloud & IT Support",
    modalTitle: "Cloud & IT Support",
    points: [
      "Create and update SharePoint sites, Intune policies and Microsoft Azure Active Directory configurations.",
      "Support Microsoft 365 and Google Workspace environments for cleaner collaboration and administration.",
      "Deploy software, support endpoint workflows and assist with tenant-level workplace digitalization.",
      "Troubleshoot hardware, software and user-support issues where business operations depend on reliable systems.",
    ],
  },
];
